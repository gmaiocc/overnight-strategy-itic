...
def run_strategy(clean_data: dict, spy_df: pd.DataFrame, use_ma200: bool) -> dict:
...
def plot_equity(baseline: dict, ma200: dict):
    ...
    def _panel(ax, x0, x1, title, show_ylabel, show_legend):
        ...
        if ds_m:
            ax.plot(ds_m, es_m, label="MA200 Trend Filter", color=COLOR_MA200, linewidth=1.8, linestyle="--")
    ...
    fig.suptitle("Overnight Effect — Baseline vs. MA200 Trend Filter", fontsize=13, fontweight="bold")
    plt.savefig("ma200_fig1_equity.png", dpi=200, bbox_inches="tight", facecolor="white", edgecolor="none")
...
def plot_drawdown(baseline: dict, ma200: dict):
    ...
    ax.plot(ma200["dates"], dd_m, color=COLOR_DD_MA200, linewidth=1.6, linestyle="--", label="MA200 Trend Filter")
    ...
    plt.savefig("ma200_fig2_drawdown.png", dpi=200, bbox_inches="tight", facecolor="white", edgecolor="none")
...
def plot_table(m_b: dict, m_m: dict):
    ...
    plt.savefig("ma200_fig3_table.png", dpi=200, bbox_inches="tight", facecolor="white", edgecolor="none")
...
if __name__ == "__main__":
    ...
    m_ma200 = compute_metrics(ma200["equity"], ma200["rets"], "MA200 Trend Filter", ma200["dates"])
